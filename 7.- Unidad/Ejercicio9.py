'''Ejercicio 9: POO
9.- Agregue un nuevo atributo a la clase Guerrero 
que indique el “estado”; el mismo puede ser “ataque” 
o “defensa”, pero siempre deberá inicializarse en “ataque”.
'''
...
print(g1.vida, g1.estado_arma, g1.estado)
