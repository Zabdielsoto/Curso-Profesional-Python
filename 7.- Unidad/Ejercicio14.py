'''Ejercicio 14: POO
Cree una nueva clase Escudo que posea los 
atributos nombre, absorción y estado. 
El atributo estado debe poseer las mismas 
características del atributo estado_escudo 
